...
#     videoName = reformatDateTime2()+'avi'
#     out60_color = cv2.VideoWriter(videoName, fourcc, fps, frameSize)
#     out60_grayscale = cv2.VideoWriter(videoName, fourcc, fps, frameSize, isColor=False)
