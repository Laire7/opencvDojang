...
import shutil # linux shell 명령어들 #osutils와 비슷하다
from enum import Enum

# 전역 변수
DEBUG = True
dsize = (224,224) # 메인에서 쓸 것
dataPath = 
...
# input : dataPath
# output : dataPath안에 jpg파일에 리스트를 가져오기
# 확장하ㅕ면 기능추가 : img_type = ['jpg', 'png', 'gif']
...
def createFolder():
    for className in classList:
        ...
        os.makedirs(os.path.join(dataPath,className), exist_ok=True) # 폴더가 있으면 그냥 넘어간다
        #os.mkdir() # 폴더를 만들다가 오류가 나면 프로그램 전체 멈춤
