#!!!!!주의사항!!!!!
####화요일에 multithread와 multiprocess 사용 없이 프로그램을 마춰서, 이번에는 앞서 언급한 두 요소들을 활용하는 프로그램을 만들려고 하였지만...
#####프로그램이 자꾸기 꺼지는 현황이 새로 일어나게 되었습니다!
#####수업 시간 전까지 이 프로그램을 수정할려고 하겠지만, 문제가 좀 복잡한 것 같아
#####박희준 교수님께도 내일 프로그램 봐주시라고 문자 요청했습니다
#####일단 화요일에 마친? 프로그램과 함께 (수정할 코드 뒤에 주석 처리 되어있습니다) 문제 있는 코드를 제출합니다. 감사합니다!!!!!
